...
async function capture() {
  ...
  await page.goto('https://beta.numeruspro.com/dashboard', { waitUntil: 'networkidle2', timeout: 30000 });
  await page.screenshot({ path: path.join(ssDir, 'web-dashboard.png'), fullPage: false });
  console.log('✅ web-dashboard.png');
